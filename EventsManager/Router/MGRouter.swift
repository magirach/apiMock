...
public struct MGRouter {
    ...
    public static var encodingStratagy = JSONEncoder.KeyEncodingStrategy.convertToSnakeCase
    public static var decodingStratagy = JSONDecoder.KeyDecodingStrategy.convertFromSnakeCase
    ...
    public init(input: MGRouterInputProtocol) {
        self.input = input
    }
